...
| 数据集 | 文档数 | 查询数 | BM25 | BGE | ColBERT |
|:-----|:-----:|:-----:|:----:|:---:|:-------:|
| **MS MARCO** | 880万 | 6980 | 0.1926 / 0.2630 | ❌ 25GB索引超内存 | ❌ 无索引 |
| **TREC-COVID** | 17万 | 50 | 0.1871 / 0.6695 | **0.2581 / 0.8461** | 0.0803 / **0.7601** |
| **nfcorpus** | 3633 | 323 | 0.1577 / 0.3382 | **0.1998 / 0.3757** | 0.1185 / 0.2705 |
| **quora** | 52万 | 10000 | 0.7470 / 0.8173 | **0.8568 / 0.9093** | 0.7113 / 0.7939 |
